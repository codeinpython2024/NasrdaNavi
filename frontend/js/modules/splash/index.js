class SplashAnimator {
    ...
    animate() {
        ...
        // Stars fade in
        this.timeline.to(stars, { opacity: 1, duration: 1 }, 0);
        ...
        gsap.to(glow, { scale: 1.1, duration: 2, repeat: -1, yoyo: true, ease: 'power1.inOut' });
        ...
        // Mascot float
        gsap.to(mascot, { y: -10, duration: 2, repeat: -1, yoyo: true, ease: 'power1.inOut', delay: 1.5 });
